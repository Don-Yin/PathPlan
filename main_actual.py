"""
This file is the main file for the real dataset. It checks the validity of the entries and targets and saves the valid ones.
...
if __name__ == "__main__":
    ...
    show_volume(
        images_itk["vessels.nii.gz"],  # the image to show on slicer (can be any but one at a time)
